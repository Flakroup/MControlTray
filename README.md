...
*(`winget` serves whatever version the community repository has already accepted, so it can lag a release behind - the newest build is always the manual download below.)*
